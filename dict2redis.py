...
class Dict2redis():
    ...
    def fscan(self, f: str, p:str = "") -> dict:
        """scans a field for data and yields the corresponding hashes. if a hash does not have a key 'field', this record is skipped.
